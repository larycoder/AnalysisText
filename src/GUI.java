...
public class GUI extends JFrame{
    ...
    protected JButton search = new JButton("START");
    //private JLabel jlb1 = new JLabel("OOP DICTIONARY", JLabel.CENTER);
    private JLabel jlb2 = new JLabel("    Enter path direction");
    ...
    protected JTextArea jtxbot = new JTextArea(4, 20);
    protected JButton addword = new JButton("Positive");
    protected JButton deleteword = new JButton("Negative");
    protected JButton editword = new JButton("Unknown");

    public GUI(){
        setResizable(false);
        setLayout(new BorderLayout(10, 20));
        setTitle("Analysis   TExt");
    ...
    public JButton getPositive() {
        return this.addword;
    }

    public JButton getNegative() {
        return this.deleteword;
    }

    public JButton getUnknow() {
